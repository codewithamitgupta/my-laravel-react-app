...
export default function Profile() {
    ...
    return (
        <>
            <div className="w-full max-w-4xl mx-auto px-6 py-10 bg-white rounded-lg shadow-md mt-10">
                {userData && (
                    <>
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Location Field */}
                            <div className="mb-4 flex items-center space-x-4">
                                <label htmlFor="location" className="block text-sm font-medium text-gray-700 w-32">Location</label>
                                <input
                                    id="location"
                                    className="mt-1 block w-full bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 text-gray-900 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                        ...
                        <div className="mt-6 flex justify-center space-x-4">
                            <button onClick={handleInformationChanges} className="w-full sm:w-auto px-6 py-2.5 bg-blue-600 text-white font-medium rounded-lg shadow-md hover:bg-blue-700 focus:ring-4 focus:ring-blue-300">
                                Update Information
                            </button>
                            <Link to="/" className="w-full sm:w-auto px-6 py-2.5 bg-gray-600 text-white font-medium rounded-lg shadow-md hover:bg-gray-700 focus:ring-4 focus:ring-gray-300">
                                Back
                            </Link>
                        </div>
                    </>
            ...
            <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg shadow-md">
